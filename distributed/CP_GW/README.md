...
This is the standard distributed deployment for API Manager. The default configuration consists of single API control planes, and two Universal Gateways.
...
- WSO2 API Manager 4.5.0 provide three docker images, there are
